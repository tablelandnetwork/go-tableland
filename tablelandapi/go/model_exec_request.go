...
type ExecRequest struct {
	// The SQL query statement(s) to execute.
	Statement *OneOfExecRequestStatement `json:"statement,omitempty"`
	// The set of params to bind to the provided statement(s).
	Params []OneOfExecRequestParamsItems `json:"params,omitempty"`
}
