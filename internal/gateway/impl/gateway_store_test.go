...
func TestGatewayInitialization(t *testing.T) {
	...
	t.Run("invalid animation uri", func(t *testing.T) {
		...
		_, err := gateway.NewGateway(nil, nil, "https://tableland.network", "https://render.tableland.xyz", "invalid uri")
		require.Error(t, err)
...
func TestGateway(t *testing.T) {
	...
	svc, err := gateway.NewGateway(
		parser, NewGatewayStore(db, nil), "https://tableland.network", "https://render.tableland.xyz", "",
	)
	require.NoError(t, err)
