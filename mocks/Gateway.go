...
import (
	...
	gateway "github.com/textileio/go-tableland/internal/gateway"
...
func (_m *Gateway) GetReceiptByTransactionHash(_a0 context.Context, _a1 tableland.ChainID, _a2 common.Hash) (gateway.Receipt, bool, error) {
	...
	var r0 gateway.Receipt
	if rf, ok := ret.Get(0).(func(context.Context, tableland.ChainID, common.Hash) gateway.Receipt); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(gateway.Receipt)
	}

	var r1 bool
	if rf, ok := ret.Get(1).(func(context.Context, tableland.ChainID, common.Hash) bool); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Get(1).(bool)
	}
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, tableland.ChainID, common.Hash) error); ok {
		r2 = rf(_a0, _a1, _a2)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *Gateway_Expecter) GetReceiptByTransactionHash(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Gateway_GetReceiptByTransactionHash_Call {
	return &Gateway_GetReceiptByTransactionHash_Call{Call: _e.mock.On("GetReceiptByTransactionHash", _a0, _a1, _a2)}
}
...
func (_c *Gateway_GetReceiptByTransactionHash_Call) Run(run func(_a0 context.Context, _a1 tableland.ChainID, _a2 common.Hash)) *Gateway_GetReceiptByTransactionHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(tableland.ChainID), args[2].(common.Hash))
	})
	return _c
}
...
func (_m *Gateway) GetTableMetadata(_a0 context.Context, _a1 tableland.ChainID, _a2 tables.TableID) (gateway.TableMetadata, error) {
	...
	var r0 gateway.TableMetadata
	if rf, ok := ret.Get(0).(func(context.Context, tableland.ChainID, tables.TableID) gateway.TableMetadata); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(gateway.TableMetadata)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, tableland.ChainID, tables.TableID) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *Gateway_Expecter) GetTableMetadata(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Gateway_GetTableMetadata_Call {
	return &Gateway_GetTableMetadata_Call{Call: _e.mock.On("GetTableMetadata", _a0, _a1, _a2)}
}
...
func (_c *Gateway_GetTableMetadata_Call) Run(run func(_a0 context.Context, _a1 tableland.ChainID, _a2 tables.TableID)) *Gateway_GetTableMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(tableland.ChainID), args[2].(tables.TableID))
	})
	return _c
}
