...
func _005_system_tree_leavesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "005_system_tree_leaves.up.sql", size: 298, mode: os.FileMode(420), modTime: time.Unix(1677101841, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
