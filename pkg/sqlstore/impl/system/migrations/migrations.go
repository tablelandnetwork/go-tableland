...
func migrations_testGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations_test.go", size: 1755, mode: os.FileMode(436), modTime: time.Unix(1652823880, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
